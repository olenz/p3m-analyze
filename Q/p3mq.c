/* Generated by Cython 0.16 on Tue Feb 18 12:24:18 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__p3mq
#define __PYX_HAVE_API__p3mq
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'p3mq' */
__PYX_EXTERN_C DL_IMPORT(double) Q_ik[][7][101];
__PYX_EXTERN_C DL_IMPORT(double) Q_ik_i[][7][101];
__PYX_EXTERN_C DL_IMPORT(double) Q_ad[][7][101];
__PYX_EXTERN_C DL_IMPORT(double) Q_ad_i[][7][101];
__PYX_EXTERN_C DL_IMPORT(int) meshes[];
__PYX_EXTERN_C DL_IMPORT(int) n_meshes;
__PYX_EXTERN_C DL_IMPORT(int) n_caos;
__PYX_EXTERN_C DL_IMPORT(int) n_points;
__PYX_EXTERN_C DL_IMPORT(double) alphaLmax;
__PYX_EXTERN_C DL_IMPORT(int) caos[];
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "p3mq"
int __pyx_module_is_main_p3mq = 0;

/* Implementation of 'p3mq' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_4p3mq_get(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
...
static char __pyx_k_15[] = "/auto.anoa/home/olenz/projects/scafacos/notebooks/Q/p3mq.pyx";
...
static char __pyx_k__Qad[] = "Qad";
static char __pyx_k__Qik[] = "Qik";
static char __pyx_k__get[] = "get";
static char __pyx_k__Qadi[] = "Qadi";
static char __pyx_k__Qiki[] = "Qiki";
static char __pyx_k__p3mq[] = "p3mq";
static char __pyx_k__array[] = "array";
static char __pyx_k__empty[] = "empty";
static char __pyx_k__numpy[] = "numpy";
static char __pyx_k__range[] = "range";
static char __pyx_k__pycaos[] = "pycaos";
static char __pyx_k____main__[] = "__main__";
static char __pyx_k____test__[] = "__test__";
static char __pyx_k__linspace[] = "linspace";
static char __pyx_k__pymeshes[] = "pymeshes";
...
static PyObject *__pyx_n_s__Qad;
static PyObject *__pyx_n_s__Qadi;
static PyObject *__pyx_n_s__Qik;
static PyObject *__pyx_n_s__Qiki;
...
static PyObject *__pyx_n_s__p3mq;
static PyObject *__pyx_n_s__pycaos;
static PyObject *__pyx_n_s__pymeshes;
...
/* Python wrapper */
static PyObject *__pyx_pw_4p3mq_1get(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyMethodDef __pyx_mdef_4p3mq_1get = {__Pyx_NAMESTR("get"), (PyCFunction)__pyx_pw_4p3mq_1get, METH_NOARGS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_4p3mq_1get(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get (wrapper)", 0);
  __pyx_self = __pyx_self;
  __pyx_r = __pyx_pf_4p3mq_get(__pyx_self);
...
static PyObject *__pyx_pf_4p3mq_get(CYTHON_UNUSED PyObject *__pyx_self) {
  PyArrayObject *__pyx_v_Qik = 0;
  PyArrayObject *__pyx_v_Qiki = 0;
  PyArrayObject *__pyx_v_Qad = 0;
  PyArrayObject *__pyx_v_Qadi = 0;
  long __pyx_v_i;
  long __pyx_v_j;
  long __pyx_v_k;
  PyObject *__pyx_v_pymeshes = NULL;
  PyObject *__pyx_v_pycaos = NULL;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_Qad;
  __Pyx_Buffer __pyx_pybuffer_Qad;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_Qadi;
  __Pyx_Buffer __pyx_pybuffer_Qadi;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_Qik;
  __Pyx_Buffer __pyx_pybuffer_Qik;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_Qiki;
  __Pyx_Buffer __pyx_pybuffer_Qiki;
  ...
  __pyx_pybuffer_Qik.pybuffer.buf = NULL;
  __pyx_pybuffer_Qik.refcount = 0;
  __pyx_pybuffernd_Qik.data = NULL;
  __pyx_pybuffernd_Qik.rcbuffer = &__pyx_pybuffer_Qik;
  __pyx_pybuffer_Qiki.pybuffer.buf = NULL;
  __pyx_pybuffer_Qiki.refcount = 0;
  __pyx_pybuffernd_Qiki.data = NULL;
  __pyx_pybuffernd_Qiki.rcbuffer = &__pyx_pybuffer_Qiki;
  __pyx_pybuffer_Qad.pybuffer.buf = NULL;
  __pyx_pybuffer_Qad.refcount = 0;
  __pyx_pybuffernd_Qad.data = NULL;
  __pyx_pybuffernd_Qad.rcbuffer = &__pyx_pybuffer_Qad;
  __pyx_pybuffer_Qadi.pybuffer.buf = NULL;
  __pyx_pybuffer_Qadi.refcount = 0;
  __pyx_pybuffernd_Qadi.data = NULL;
  __pyx_pybuffernd_Qadi.rcbuffer = &__pyx_pybuffer_Qadi;
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(n_meshes); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromLong(n_caos); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyInt_FromLong(n_points); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = 0;
  __pyx_t_5 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_4), NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_Qik.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
      __pyx_v_Qik = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_Qik.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_Qik.diminfo[0].strides = __pyx_pybuffernd_Qik.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_Qik.diminfo[0].shape = __pyx_pybuffernd_Qik.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_Qik.diminfo[1].strides = __pyx_pybuffernd_Qik.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_Qik.diminfo[1].shape = __pyx_pybuffernd_Qik.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_Qik.diminfo[2].strides = __pyx_pybuffernd_Qik.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_Qik.diminfo[2].shape = __pyx_pybuffernd_Qik.rcbuffer->pybuffer.shape[2];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_Qik = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__empty); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromLong(n_meshes); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = PyInt_FromLong(n_caos); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyInt_FromLong(n_points); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_Qiki.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
      __pyx_v_Qiki = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_Qiki.diminfo[0].strides = __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_Qiki.diminfo[0].shape = __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_Qiki.diminfo[1].strides = __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_Qiki.diminfo[1].shape = __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_Qiki.diminfo[2].strides = __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_Qiki.diminfo[2].shape = __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.shape[2];
    }
  }
  __pyx_t_7 = 0;
  __pyx_v_Qiki = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__empty); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromLong(n_meshes); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = PyInt_FromLong(n_caos); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = PyInt_FromLong(n_points); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_Qad.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
      __pyx_v_Qad = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_Qad.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_Qad.diminfo[0].strides = __pyx_pybuffernd_Qad.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_Qad.diminfo[0].shape = __pyx_pybuffernd_Qad.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_Qad.diminfo[1].strides = __pyx_pybuffernd_Qad.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_Qad.diminfo[1].shape = __pyx_pybuffernd_Qad.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_Qad.diminfo[2].strides = __pyx_pybuffernd_Qad.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_Qad.diminfo[2].shape = __pyx_pybuffernd_Qad.rcbuffer->pybuffer.shape[2];
    }
  }
  __pyx_t_8 = 0;
  __pyx_v_Qad = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__empty); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromLong(n_meshes); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = PyInt_FromLong(n_caos); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyInt_FromLong(n_points); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GIVEREF(((PyObject *)__pyx_t_1));
  __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_4), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_Qadi.rcbuffer->pybuffer, (PyObject*)__pyx_t_9, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
      __pyx_v_Qadi = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_Qadi.diminfo[0].strides = __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_Qadi.diminfo[0].shape = __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_Qadi.diminfo[1].strides = __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_Qadi.diminfo[1].shape = __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_Qadi.diminfo[2].strides = __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_Qadi.diminfo[2].shape = __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.shape[2];
    }
  }
  __pyx_t_9 = 0;
  __pyx_v_Qadi = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 */
        ...
        __pyx_t_16 = -1;
        if (__pyx_t_13 < 0) {
          __pyx_t_13 += __pyx_pybuffernd_Qik.diminfo[0].shape;
          if (unlikely(__pyx_t_13 < 0)) __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_Qik.diminfo[0].shape)) __pyx_t_16 = 0;
        if (__pyx_t_14 < 0) {
          __pyx_t_14 += __pyx_pybuffernd_Qik.diminfo[1].shape;
          if (unlikely(__pyx_t_14 < 0)) __pyx_t_16 = 1;
        } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_Qik.diminfo[1].shape)) __pyx_t_16 = 1;
        if (__pyx_t_15 < 0) {
          __pyx_t_15 += __pyx_pybuffernd_Qik.diminfo[2].shape;
          if (unlikely(__pyx_t_15 < 0)) __pyx_t_16 = 2;
        } else if (unlikely(__pyx_t_15 >= __pyx_pybuffernd_Qik.diminfo[2].shape)) __pyx_t_16 = 2;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrCContig3d(double *, __pyx_pybuffernd_Qik.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_Qik.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_Qik.diminfo[1].strides, __pyx_t_15, __pyx_pybuffernd_Qik.diminfo[2].strides) = (((Q_ik[__pyx_v_i])[__pyx_v_j])[__pyx_v_k]);
 ...
 */
        ...
        __pyx_t_16 = -1;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_pybuffernd_Qiki.diminfo[0].shape;
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_Qiki.diminfo[0].shape)) __pyx_t_16 = 0;
        if (__pyx_t_18 < 0) {
          __pyx_t_18 += __pyx_pybuffernd_Qiki.diminfo[1].shape;
          if (unlikely(__pyx_t_18 < 0)) __pyx_t_16 = 1;
        } else if (unlikely(__pyx_t_18 >= __pyx_pybuffernd_Qiki.diminfo[1].shape)) __pyx_t_16 = 1;
        if (__pyx_t_19 < 0) {
          __pyx_t_19 += __pyx_pybuffernd_Qiki.diminfo[2].shape;
          if (unlikely(__pyx_t_19 < 0)) __pyx_t_16 = 2;
        } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_Qiki.diminfo[2].shape)) __pyx_t_16 = 2;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrCContig3d(double *, __pyx_pybuffernd_Qiki.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_Qiki.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_Qiki.diminfo[1].strides, __pyx_t_19, __pyx_pybuffernd_Qiki.diminfo[2].strides) = (((Q_ik_i[__pyx_v_i])[__pyx_v_j])[__pyx_v_k]);
 ...
 */
        ...
        __pyx_t_16 = -1;
        if (__pyx_t_20 < 0) {
          __pyx_t_20 += __pyx_pybuffernd_Qad.diminfo[0].shape;
          if (unlikely(__pyx_t_20 < 0)) __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_20 >= __pyx_pybuffernd_Qad.diminfo[0].shape)) __pyx_t_16 = 0;
        if (__pyx_t_21 < 0) {
          __pyx_t_21 += __pyx_pybuffernd_Qad.diminfo[1].shape;
          if (unlikely(__pyx_t_21 < 0)) __pyx_t_16 = 1;
        } else if (unlikely(__pyx_t_21 >= __pyx_pybuffernd_Qad.diminfo[1].shape)) __pyx_t_16 = 1;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_pybuffernd_Qad.diminfo[2].shape;
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_16 = 2;
        } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_Qad.diminfo[2].shape)) __pyx_t_16 = 2;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrCContig3d(double *, __pyx_pybuffernd_Qad.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_Qad.diminfo[0].strides, __pyx_t_21, __pyx_pybuffernd_Qad.diminfo[1].strides, __pyx_t_22, __pyx_pybuffernd_Qad.diminfo[2].strides) = (((Q_ad[__pyx_v_i])[__pyx_v_j])[__pyx_v_k]);
 ...
 */
        ...
        __pyx_t_16 = -1;
        if (__pyx_t_23 < 0) {
          __pyx_t_23 += __pyx_pybuffernd_Qadi.diminfo[0].shape;
          if (unlikely(__pyx_t_23 < 0)) __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_23 >= __pyx_pybuffernd_Qadi.diminfo[0].shape)) __pyx_t_16 = 0;
        if (__pyx_t_24 < 0) {
          __pyx_t_24 += __pyx_pybuffernd_Qadi.diminfo[1].shape;
          if (unlikely(__pyx_t_24 < 0)) __pyx_t_16 = 1;
        } else if (unlikely(__pyx_t_24 >= __pyx_pybuffernd_Qadi.diminfo[1].shape)) __pyx_t_16 = 1;
        if (__pyx_t_25 < 0) {
          __pyx_t_25 += __pyx_pybuffernd_Qadi.diminfo[2].shape;
          if (unlikely(__pyx_t_25 < 0)) __pyx_t_16 = 2;
        } else if (unlikely(__pyx_t_25 >= __pyx_pybuffernd_Qadi.diminfo[2].shape)) __pyx_t_16 = 2;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrCContig3d(double *, __pyx_pybuffernd_Qadi.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_Qadi.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_Qadi.diminfo[1].strides, __pyx_t_25, __pyx_pybuffernd_Qadi.diminfo[2].strides) = (((Q_ad_i[__pyx_v_i])[__pyx_v_j])[__pyx_v_k]);
      }
    }
  }
 ...
 *     pycaos = []
 */
    __pyx_t_1 = PyInt_FromLong((meshes[__pyx_v_i])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_26 = PyList_Append(__pyx_v_pymeshes, __pyx_t_1); if (unlikely(__pyx_t_26 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }
 ...
 */
    __pyx_t_1 = PyInt_FromLong((caos[__pyx_v_i])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_26 = PyList_Append(__pyx_v_pycaos, __pyx_t_1); if (unlikely(__pyx_t_26 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__array); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(((PyObject *)__pyx_v_pymeshes));
  PyTuple_SET_ITEM(__pyx_t_1, 0, ((PyObject *)__pyx_v_pymeshes));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_pymeshes));
  ...
  __pyx_t_1 = PyTuple_New(1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(((PyObject *)__pyx_v_pycaos));
  PyTuple_SET_ITEM(__pyx_t_1, 0, ((PyObject *)__pyx_v_pycaos));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_pycaos));
  __pyx_t_3 = PyObject_Call(__pyx_t_4, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__linspace); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = PyFloat_FromDouble(alphaLmax); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_27 = PyInt_FromLong(n_points); if (unlikely(!__pyx_t_27)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_27);
  __pyx_t_28 = PyTuple_New(3); if (unlikely(!__pyx_t_28)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = 0;
  __pyx_t_27 = 0;
  __pyx_t_27 = PyObject_Call(__pyx_t_4, ((PyObject *)__pyx_t_28), NULL); if (unlikely(!__pyx_t_27)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_27);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_28)); __pyx_t_28 = 0;
  __pyx_t_28 = PyTuple_New(7); if (unlikely(!__pyx_t_28)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_28);
  ...
  PyTuple_SET_ITEM(__pyx_t_28, 2, __pyx_t_27);
  __Pyx_GIVEREF(__pyx_t_27);
  __Pyx_INCREF(((PyObject *)__pyx_v_Qik));
  PyTuple_SET_ITEM(__pyx_t_28, 3, ((PyObject *)__pyx_v_Qik));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_Qik));
  __Pyx_INCREF(((PyObject *)__pyx_v_Qiki));
  PyTuple_SET_ITEM(__pyx_t_28, 4, ((PyObject *)__pyx_v_Qiki));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_Qiki));
  __Pyx_INCREF(((PyObject *)__pyx_v_Qad));
  PyTuple_SET_ITEM(__pyx_t_28, 5, ((PyObject *)__pyx_v_Qad));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_Qad));
  __Pyx_INCREF(((PyObject *)__pyx_v_Qadi));
  PyTuple_SET_ITEM(__pyx_t_28, 6, ((PyObject *)__pyx_v_Qadi));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_Qadi));
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  __pyx_t_27 = 0;
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_Qad.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_Qadi.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_Qik.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_Qiki.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("p3mq.get", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_Qad.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_Qiki.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_Qik);
  __Pyx_XDECREF((PyObject *)__pyx_v_Qiki);
  __Pyx_XDECREF((PyObject *)__pyx_v_Qad);
  __Pyx_XDECREF((PyObject *)__pyx_v_Qadi);
  __Pyx_XDECREF(__pyx_v_pymeshes);
  __Pyx_XDECREF(__pyx_v_pycaos);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__Qad, __pyx_k__Qad, sizeof(__pyx_k__Qad), 0, 0, 1, 1},
  {&__pyx_n_s__Qadi, __pyx_k__Qadi, sizeof(__pyx_k__Qadi), 0, 0, 1, 1},
  {&__pyx_n_s__Qik, __pyx_k__Qik, sizeof(__pyx_k__Qik), 0, 0, 1, 1},
  {&__pyx_n_s__Qiki, __pyx_k__Qiki, sizeof(__pyx_k__Qiki), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__p3mq, __pyx_k__p3mq, sizeof(__pyx_k__p3mq), 0, 0, 1, 1},
  {&__pyx_n_s__pycaos, __pyx_k__pycaos, sizeof(__pyx_k__pycaos), 0, 0, 1, 1},
  {&__pyx_n_s__pymeshes, __pyx_k__pymeshes, sizeof(__pyx_k__pymeshes), 0, 0, 1, 1},
 ...
 *     cdef np.ndarray[double, ndim=3, mode='c'] Qiki = np.empty((n_meshes, n_caos, n_points))
 */
  __pyx_k_tuple_13 = PyTuple_New(9); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_13);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__Qik));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 0, ((PyObject *)__pyx_n_s__Qik));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__Qik));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__Qiki));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 1, ((PyObject *)__pyx_n_s__Qiki));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__Qiki));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__Qad));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 2, ((PyObject *)__pyx_n_s__Qad));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__Qad));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__Qadi));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 3, ((PyObject *)__pyx_n_s__Qadi));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__Qadi));
  ...
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 6, ((PyObject *)__pyx_n_s__k));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__k));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__pymeshes));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 7, ((PyObject *)__pyx_n_s__pymeshes));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__pymeshes));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__pycaos));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 8, ((PyObject *)__pyx_n_s__pycaos));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__pycaos));
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_13));
  __pyx_k_codeobj_14 = (PyObject*)__Pyx_PyCode_New(0, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__get, 18, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initp3mq(void); /*proto*/
PyMODINIT_FUNC initp3mq(void)
#else
PyMODINIT_FUNC PyInit_p3mq(void); /*proto*/
PyMODINIT_FUNC PyInit_p3mq(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_p3mq(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("p3mq"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
 ...
 *     cdef np.ndarray[double, ndim=3, mode='c'] Qiki = np.empty((n_meshes, n_caos, n_points))
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4p3mq_1get, NULL, __pyx_n_s__p3mq); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__get, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init p3mq", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init p3mq");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
